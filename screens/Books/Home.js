...
const Home = ({ navigation }) => {
        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                <View style={{ paddingHorizontal: SIZES.padding, flexDirection: 'row', justifyContent: 'space-between' }}>
                    ...
                    >
                        <Text style={{ ...FONTS.body3, color: COLORS.lightGray, alignSelf: 'flex-start', textDecorationLine: 'underline' }}>Lihat Lainnya</Text>
                    </TouchableOpacity>
                </View>
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.white }}>
            ...
            {/* Body Section */}
            <ScrollView style={{ marginTop: SIZES.radius }} showsVerticalScrollIndicator={false}>
                {/* Books Section */}
                {
                    initHome()
                }
